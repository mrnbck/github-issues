            ...
            <Router >
              <Route path={'/issues/:currentPage'} 
                render={({ match }) => 
                  ...
                  />}/>
              <span>
                <Link to={`/issues/${Number(currentPage)-1}`} ><span className='pagination'>Previous </span></Link>
                <Link to='/issues/1'><span className='pagination'>1 </span></Link>
                <Link to='/issues/2'><span className='pagination'>2 </span></Link>
                <span className='pagination'> ... </span>
                <Link to={`/issues/${last-4}`}><span className='pagination'>{last-4} </span></Link>
                <Link to={`/issues/${last-3}`}><span className='pagination'>{last-3} </span></Link>
                <Link to={`/issues/${last-2}`}><span className='pagination'>{last-2} </span></Link>
                <Link to={`/issues/${last-1}`}><span className='pagination'>{last-1} </span></Link>
                <Link to={`/issues/${last}`}><span className='pagination'>{last} </span></Link>
          ...
          <span >
            <Router >
              ...
              <span>
                ...
                <Link to={`/issues/${last-1}`}><span className='pagination'>{last-1} </span></Link>
                <Link to={`/issues/${last}`}><span className='pagination'>{last} </span></Link>
                <Link to={`/issues/${Number(currentPage)+1}`}><span className='pagination'>Next </span></Link>               
              </span>
            </Router>
          </span>
          ...
          <span>
            <Router >
              ...
              <span>
                ...
                <Link to='/issues/1'><span className='pagination'>1 </span></Link>
                <Link to='/issues/2'><span className='pagination'>2 </span></Link>
                <Link to='/issues/3'><span className='pagination'>3 </span></Link>
                <Link to='/issues/4'><span className='pagination'>4 </span></Link>
                <Link to='/issues/5'><span className='pagination'>5 </span></Link>
                <span className='pagination'> ... </span>
                <Link to={`/issues/${last-1}`}><span className='pagination'>{last-1} </span></Link>
                <Link to={`/issues/${last}`}><span className='pagination'>{last} </span></Link>
                <Link to={`/issues/${Number(currentPage)+1}`}><span className='pagination'>Next </span></Link>
          ...
          <span>
            <Router >
              ...
              <span>
                ...
                <Link to='/issues/2'><span className='pagination'>2 </span></Link>
                <span className='pagination'> ... </span>
                <Link to={`/issues/${Number(currentPage)}`}><span className='pagination'>{Number(currentPage)} </span></Link>
                <Link to={`/issues/${Number(currentPage)+1}`}><span className='pagination'>{Number(currentPage)+1} </span></Link>
                <Link to={`/issues/${Number(currentPage)+2}`}><span className='pagination'>{Number(currentPage)+2} </span></Link>
                <span className='pagination'> ... </span>
                <Link to={`/issues/${last-1}`}><span className='pagination'>{last-1} </span></Link>
                <Link to={`/issues/${last}`}><span className='pagination'>{last} </span></Link>
                <Link to={`/issues/${Number(currentPage)+1}`}><span className='pagination'>Next </span></Link>
